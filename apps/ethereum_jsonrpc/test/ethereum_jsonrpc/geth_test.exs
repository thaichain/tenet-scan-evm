defmodule EthereumJSONRPC.GethTest do
  ...
  describe "fetch_internal_transactions/2" do
    ...
    test "call_tracer contract calls results are the same as js tracer", %{
      ...
      js_internal_txs = Geth.fetch_internal_transactions([transaction_params], json_rpc_named_arguments)

      Application.put_env(:ethereum_jsonrpc, Geth, tracer: "call_tracer")

      assert ^js_internal_txs = Geth.fetch_internal_transactions([transaction_params], json_rpc_named_arguments)
    end
